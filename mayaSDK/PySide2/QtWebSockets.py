...
class QWebSocketProtocol(_Object):
    ...
    CloseCodeAbnormalDisconnection = None
    
    
    CloseCodeBadOperation = None
    
    
    CloseCodeDatatypeNotSupported = None
    
    
    CloseCodeGoingAway = None
    
    
    CloseCodeMissingExtension = None
    
    
    CloseCodeMissingStatusCode = None
    
    
    CloseCodeNormal = None
    
    
    CloseCodePolicyViolated = None
    
    
    CloseCodeProtocolError = None
    
    
    CloseCodeReserved1004 = None
    
    
    CloseCodeTlsHandshakeFailed = None
    
    
    CloseCodeTooMuchData = None
    
    
    CloseCodeWrongDatatype = None
...
class QWebSocketServer(_QObject):
    ...
    originAuthenticationRequired = None
...
class QWebSocket(_QObject):
    ...
    binaryFrameReceived = None
    
    
    binaryMessageReceived = None
    ...
    textFrameReceived = None
    
    
    textMessageReceived = None
