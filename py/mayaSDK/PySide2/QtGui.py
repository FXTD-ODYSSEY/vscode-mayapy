...
class QOpenGLBuffer(_Object):
    ...
    RangeAccessFlag = None
    
    
    RangeAccessFlags = None
...
class QScreen(_QObject):
    ...
    availableGeometryChanged = None
    
    
    geometryChanged = None
    
    
    logicalDotsPerInchChanged = None
    
    
    orientationChanged = None
    
    
    physicalDotsPerInchChanged = None
    
    
    physicalSizeChanged = None
    
    
    primaryOrientationChanged = None
    
    
    refreshRateChanged = None
    
    
    staticMetaObject = None
    
    
    virtualGeometryChanged = None
...
class QOpenGLContext(_QObject):
    ...
    OpenGLModuleType = None
    
    
    __new__ = None
    
    
    aboutToBeDestroyed = None
...
class QAccessible(_Object):
    ...
    ComplementaryContent = None
    
    
    ContextHelpEnd = None
    
    
    ContextHelpStart = None
    ...
    DefaultActionChanged = None
    
    
    Description = None
    
    
    DescriptionChanged = None
    ...
    DocumentContentChanged = None
    
    
    DocumentLoadComplete = None
    
    
    DocumentLoadStopped = None
    ...
    HyperlinkEndIndexChanged = None
    
    
    HyperlinkNumberOfAnchorsChanged = None
    
    
    HyperlinkSelectedLinkChanged = None
    
    
    HyperlinkStartIndexChanged = None
    
    
    HypertextChanged = None
    
    
    HypertextLinkActivated = None
    
    
    HypertextLinkSelected = None
    
    
    HypertextNLinksChanged = None
    ...
    ObjectAttributeChanged = None
    
    
    ObjectCreated = None
    
    
    ObjectDestroyed = None
    ...
    TableCaptionChanged = None
    
    
    TableCellInterface = None
    
    
    TableColumnDescriptionChanged = None
    
    
    TableColumnHeaderChanged = None
    
    
    TableInterface = None
    
    
    TableModelChanged = None
    
    
    TableRowDescriptionChanged = None
    
    
    TableRowHeaderChanged = None
    
    
    TableSummaryChanged = None
    ...
    TextAttributeChanged = None
    
    
    TextBoundaryType = None
    
    
    TextCaretMoved = None
    
    
    TextColumnChanged = None
...
class QGuiApplication(_QCoreApplication):
    ...
    applicationStateChanged = None
    
    
    commitDataRequest = None
    
    
    focusObjectChanged = None
    
    
    focusWindowChanged = None
    ...
    layoutDirectionChanged = None
    
    
    paletteChanged = None
    
    
    primaryScreenChanged = None
...
class QTextCharFormat(QTextFormat):
    ...
    FontPropertiesInheritanceBehavior = None
...
class QWindow(_QObject, QSurface):
    ...
    contentOrientationChanged = None
    ...
    maximumHeightChanged = None
    
    
    maximumWidthChanged = None
    
    
    minimumHeightChanged = None
    
    
    minimumWidthChanged = None
    
    
    modalityChanged = None
...
class QDoubleValidator(QValidator):
    ...
    decimalsChanged = None
    
    
    notationChanged = None
